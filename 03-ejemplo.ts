...
let executionMethodInsert = false;

class DatabaseFake implements OperationDatabase {
  insert(medic: Medic): void {
    console.log("medic inserted");
    executionMethodInsert = true;
  }
...
// Preparación
const medic = new Medic(1, "Juan", "Arriola", 23, "ab123", 1, 2);
const database = new DatabaseFake();

// Ejecución
const usecase = new MedicInsert(database);
usecase.execute(medic);

// Comprobación
if (executionMethodInsert) {
